/*
import {AsyncCheckFunction, SyncCheckFunction, ValidationError, ValidationSchema} from 'fastest-validate';
import pkg from '../util/validate.cjs';
...
export const defaultBootstrapOptions: BootstrapOptions = {
  'project root': './dual-build-project-replace-me',
